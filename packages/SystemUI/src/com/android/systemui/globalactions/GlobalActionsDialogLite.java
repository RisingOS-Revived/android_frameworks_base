...
public class GlobalActionsDialogLite implements DialogInterface.OnDismissListener,
    ...
    protected String[] getRestartActions() {
        String[] defaultActions = mResources.getStringArray(
                org.lineageos.platform.internal.R.array.config_restartActionsList);
        List<String> actionsList = new ArrayList<>(Arrays.asList(defaultActions));
        actionsList.add("restart_systemui");
        return actionsList.toArray(new String[0]);
    }
