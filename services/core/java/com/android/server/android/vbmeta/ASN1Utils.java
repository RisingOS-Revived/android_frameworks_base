...
public class ASN1Utils {
    ...
    public static String getStringFromASN1PrintableString(ASN1Encodable encodable) throws CertificateParsingException {
        if (!(encodable instanceof ASN1PrintableString printableString)) {
            throw new CertificateParsingException("Expected printable string, found " + encodable.getClass().getName());
        }
